...
window.onload = function () {
  ...
  const firebaseConfig = {
    apiKey: 'AIzaSyAciBmwdCii3akvR-qgHUn6PZ1I2nR9pZQ',
    authDomain: 'memechat2-d13ce.firebaseapp.com',
    projectId: 'memechat2-d13ce',
    storageBucket: 'memechat2-d13ce.appspot.com',
    messagingSenderId: '812038306715',
    appId: '1:812038306715:web:bbbab91fdd91025c1abf3e'
  };
  ...
  class MEME_CHAT {
    ...
    refresh_chat () {
      ...
      db.ref('chats/').on('value', function (messages_object) {
        ...
        const guide = []; // this will be our guide to organizing the messages
        let unordered = []; // unordered messages
        const ordered = []; // we're going to order these messages
